...
$(document).on('click','#KoBlogSN', function(){$("body").toggleClass('KoBlogSN');});
});

$(document).ready(function(){$(document).on('click', '#KoBlogDropN', function(){if($('#KoBlogShowN').hasClass('koblog-sidenav')){$('#KoBlogShowN').removeClass('koblog-sidenav');}else{$('#KoBlogShowN').addClass('koblog-sidenav');}});});
